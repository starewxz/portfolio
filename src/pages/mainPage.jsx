...
const MainPage = () => {
    ...
    return (
        <div>
            <Header />
            <main className="relative flex flex-col lg:flex-col items-center justify-start px-4 sm:px-10 lg:px-20 gap-6 pt-6 lg:pt-5 pb-20 mt-10">
                    ...
                    <div className="relative w-[250px] h-[350px] sm:block hidden sm:w-[300px] sm:h-[420px] lg:w-[400px] lg:h-[630px] sm:mt-6 lg:mt-0 flex-shrink-0">
                        <div
                            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
                              ...
                              bg-[#001EFF] rounded-[50%_40%_60%_50%/50%_60%_40%_50%] opacity-70 sm:opacity-70
                              glow-blur xs:block"
                        />
                        <img
