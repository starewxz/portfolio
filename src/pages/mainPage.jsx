    ...
    return (
        <div>
            ...
            <main className="relative flex flex-col-reverse lg:flex-row items-center justify-center px-4 sm:px-10 lg:px-20 mt-10 gap-10 overflow-hidden">
                ...
                <div className="z-10 flex justify-center items-center lg:justify-start animate-slide-in-left sm:w-1/2 w-full max-w-md mx-auto">
                    <Card />
                </div>

                <div className="relative w-[250px] h-[350px] sm:block hidden sm:w-[300px] sm:h-[420px] lg:w-[400px] lg:h-[630px] sm:mt-10 lg:mt-20 flex-shrink-0">
